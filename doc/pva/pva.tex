...
Ook is er een opdracht voor een robot die zo dicht mogelijk tot een afgrond moeten rijden(Challenge B). Deze robot moet in het zelfde tijdsaspect moeten worden afgeleverd en ook voor deze robot geld dat alle benodigdheden worden gesponsord door de hogeschool.\\
\\
Na afronding van dit project leveren wij een werkende robot die een doolhof kan doorkruizen en een robot die tot een afgrond kan rijden.
\clearpage
...
\clearpage
\chapter{Kwaliteit}
Om de kwaliteit van de tussen resultaten en eindresultaten te waarborgen wordt voor elk resultaat een rapport gemaakt dat vervolgens wordt gecontroleerd door de projectleider.\\

De resultaten worden ook besproken in een vergadering die het team wekelijks houdt. In deze vergadering worden dan de behaalde resultaten besproken met het team en vervolgens een beslissing gemaakt om het resultaat wel of niet aan te passen. \\

Als een niet goed gekeurd tussen of eindresultaat te veel complicaties opleverd zullen wij om advies vragen bij mevrouw Muilwijk en/of mevrouw Van der Ven.\\

Voor het schrijven van de programmatuur gebruiken wij de SimpleIDE editor, omdat de SimpleIDE wordt de code direct naar de Activitybot kan uploaden.\\
...
Intern:
De interne communicatie tussen projectleden wordt geregeld via een *Telegram groepchat,
